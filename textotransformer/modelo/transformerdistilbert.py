...
class TransformerDistilbert(Transformer):
    '''
    Classe que encapsula a classe DistilBertModel da Huggingface para gerar embeddings de token, palavra, sentença ou texto.
    '''
    ...
    def __init__(self, auto_model: AutoModel = None, 
        ...
        '''
        Construtor da classe TransformerDistilbert.
        ...
        super(TransformerDistilbert, self).__init__(
    ...
    def getTokensPalavrasEmbeddingsTexto(self, 
        ...
        # Tokenização Wordpiece (Separador, ##) para DistilBert
