...
class TestTextTransformer_openaigpt_en(unittest.TestCase):
    ...
    def test_getCodificacaoCompleta_list_string(self):
        ...
        self.assertEqual(len(saida['token_embeddings'][0]), 8) # tokens
        ...
        self.assertEqual(len(saida['all_layer_embeddings'][0][0]), 8) # 8 tokens
    ...
    def test_getCodificacaoSentenca_string(self):
        ...
        # Testa a saida dos valores das chaves        
        self.assertEqual(len(saida['tokens_texto_mcl']), 16)
    ...
    def test_getCodificacaoSentenca_lista_string(self):
        ...
        # Testa a saida dos valores das chaves        
        self.assertEqual(len(saida['tokens_texto_mcl']), 2)
        self.assertEqual(len(saida['tokens_texto_mcl'][0]), 16)
    ...
    def test_getCodificacaoPalavra_lista_string(self):
        ...
        self.assertEqual(saida['texto_original'][1], texto[1].lower())
        # Testa as palavras fora do vocabulário
        self.assertListEqual(saida['tokens_oov_texto_mcl'][0], [0, 0, 0, 0, 0, 0, 0, 0])
    ...
    def test_getEmbeddingTexto_similaridadeCosseno(self):
        ...
        # Valores esperados
        sim12Esperado = 0.6160804629325867
        sim13Esperado = 0.5424067974090576
        sim23Esperado = 0.6180431842803955
    ...
    def test_getCodificacaoToken_similaridadeCosseno(self):
        ...
        idx_tokens = getIndexTokenTexto(saida['tokens_texto_mcl'], "bank</w>")
        ...
        # Valores esperados
        sim12Esperado = 0.7032352685928345
        sim13Esperado = 0.5836779475212097
        sim23Esperado = 0.34492143988609314
    ...
    def test_getEmbeddingTexto_produtoEscalar(self):
        ...
        # Avalia o produto escalar entre os embeddings dos textos
        ...
        # Valores esperados
        pro12Esperado = 64.2356185913086
        pro13Esperado = 63.72175598144531
        pro23Esperado = 75.04673767089844
    ...
    def test_getCodificacaoToken_produtoEscalar(self):
        ...
        # Valores esperados
        pro12Esperado = 256.8798522949219
        pro13Esperado = 226.06381225585938
        pro23Esperado = 122.34829711914062
    ...
    def test_getCodificacaoToken_distanciaEuclidiana(self):
        ...
        # Valores esperados
        dif12Esperado = 14.81995677947998
        dif13Esperado = 17.967321395874023
        dif23Esperado = 21.585800170898438
    ...
    def test_getCodificacaoToken_distanciaManhattan(self):
        ...
        # Valores esperados
        dif12Esperado = 322.03915
        dif13Esperado = 386.87018
        dif23Esperado = 465.57556
