...
class TestTextTransformer_roberta_en(unittest.TestCase):
    ...
    # Testes TextoTransformer_roberta_en
    def test_textotransformer(self):
        logger.info("Testando o construtor de TextoTransformer_roberta_en")
                
        self.assertIsNotNone(self.modelo)
        self.assertIsInstance(self.modelo.getTransformer(), TransformerRoberta)
    ...
    def test_getMedidasTexto(self):
        ...
        CproEsperado =137.21603393554688
    ...
    def test_getMedidasTexto_PalavraRelevante_1(self):
        ...
        CproEsperado = 131.11929321289062
    ...
    def test_getEmbeddingTexto_produtoEscalar(self):
        ...
        # Valores esperados
        pro12Esperado = 139.5528106689453
        pro13Esperado = 142.6826934814453
        pro23Esperado = 144.5050048828125
    ...
    def test_getCodificacaoToken_produtoEscalar(self):
        ...
        # Valores esperados
        pro12Esperado = 171.42599487304688
        pro13Esperado = 153.55064392089844
        pro23Esperado = 152.45358276367188
...
if "__main__" == __name__:
    ...
    logger.info("Teste TextoTransformer_roberta_en")
    unittest.main()
