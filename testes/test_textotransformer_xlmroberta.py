...
class TestTextTransformer_xlmroberta_en(unittest.TestCase):
    ...
    def test_getMedidasTexto(self):
        ...
        CproEsperado = 363.66766357421875
    ...
    def test_getMedidasTexto_PalavraRelevante_1(self):
        ...
        CproEsperado = 364.05694580078125
    ...
    def test_getMedidasTexto_PalavraRelevante_2(self):
        ...
        casas_decimais = 5
        self.assertAlmostEqual(saida['cos'], CcosEsperado, places=casas_decimais)
        self.assertAlmostEqual(saida['pro'], CcosEsperado, places=casas_decimais)
        self.assertAlmostEqual(saida['euc'], CeucEsperado, places=casas_decimais)
        self.assertAlmostEqual(saida['man'], CmanEsperado, places=casas_decimais) 
    ...
    def test_getEmbeddingTexto_produtoEscalar(self):
        ...
        # Valores esperados
        pro12Esperado = 362.7056884765625
        pro13Esperado = 362.97967529296875
        pro23Esperado = 363.1423645019531
    ...
    def test_getCodificacaoToken_produtoEscalar(self):
        ...
        # Valores esperados
        pro12Esperado = 371.18304443359375
        pro13Esperado = 372.5065002441406
        pro23Esperado = 372.7232971191406
